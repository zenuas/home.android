	...
	extends Activity
{
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		case R.id.hidden_applications:
			...
			//intent.putExtra(HiddenApplications.class.getName() + ".apps", new ObjectParcelable<>(getLauncherApplications()));
			//intent.putExtra(HiddenApplications.class.getName() + ".hidden", new ObjectParcelable<>(getHiddenApplications()));
		...
		case R.id.send_bugreport:
			...
			ApplicationContext.getContext().sendBugReport();
			break;
